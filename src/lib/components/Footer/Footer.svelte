...
<footer class="py-12 bg-gradient-to-r from-accent to-accent-light">
  <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
    ...
    >
      <div class="xl:flex xl:items-center xl:justify-start">
        <img class="w-auto mx-auto h-7" src={Logo} alt="Carlton Town FC Logo" />

        <p class="mt-5 text-sm text-white xl:ml-6 xl:mt-0">
          © Copyright {new Date().getFullYear()} Carlton Town FC.
        </p>
      </div>
      ...
      >
        ...
        <div
          class="w-full h-px mt-8 mb-5 bg-gray-50/20 xl:m-0 xl:h-6 xl:w-px"
        ></div>
